...
url = "https://66738677adbf0576.247ctf.com/" # SET THE HOST
...
def request_cipher_text_and_get_IV(padding):
	...
	global byte_to_find
	byte_to_find = result.text[32:63]# Insted of comparing last byte, all 32 bytes must be compared
...
while True:
	for letter in possible_letters:
		...
		print "############################### RESULT WE       HAVE: " + local_result.text[32:63]

		if local_result.text[32:63] == byte_to_find:
			...
			#print "EL IV DE LAS COOKIES ES: " + get_IV_from_cookies(local_result.cookies.get_dict())
			#print "################# XLOCAL_IV: " + local_IV
			#print "################# LENGTH: " + str(len(local_IV))
